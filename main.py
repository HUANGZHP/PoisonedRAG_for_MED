...
def parse_args():
    ...
    parser.add_argument("--eval_model_code", type=str, default="contriever", choices=["contriever", "contriever_v1", "contriever-msmarco", "contriever-chinese", "ance", "dpr", "medcpt", "bm25"])
