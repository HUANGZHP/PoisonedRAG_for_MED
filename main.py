...
def parse_args():
    ...
    parser.add_argument("--eval_model_code", type=str, default="contriever", choices=["contriever", "contriever-msmarco", "ance", "dpr", "medcpt", "bm25"])
    parser.add_argument('--eval_dataset', type=str, default="nq", choices=["nq", "hotpotqa", "msmarco", "pubmed", "statpearls", "textbooks"], help='Dataset to evaluate (BEIR or MedRAG corpus)')
